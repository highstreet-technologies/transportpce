...
public class TestRemoteMountpointService {
    ...
    public void testRpcDeserializer() throws IOException {
        ...
        LedControlOutput output = mapper.readValue("<output xmlns=\"http://org/openroadm/device\">\n"
                ...
                LedControlOutput.class);
        LOG.info("{}", output);
    }

    @Test
    public void testAugment()
            throws NotImplementedException, ClassNotFoundException, NoSuchFieldException, SecurityException,
            IllegalArgumentException, IllegalAccessException, InterruptedException, ExecutionException, IOException {
        RestconfHttpClient restClient =
                new RestconfHttpClient(BASEURL, false, AuthMethod.BASIC, ODL_USERNAME, ODL_PASSWD);
