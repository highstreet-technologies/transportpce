...
public class YangToolsBuilderAnnotationIntrospectorXml extends JacksonXmlAnnotationIntrospector {

    private static final Logger LOG = LoggerFactory.getLogger(YangToolsBuilderAnnotationIntrospectorXml.class);
    private static final long serialVersionUID = 1L;
    private final BundleContext context;
    private final Map<Class<?>, String> customDeserializer;

    public YangToolsBuilderAnnotationIntrospectorXml() {
        this(YangToolsMapperHelper.getBundleContext());
    }

    public YangToolsBuilderAnnotationIntrospectorXml(BundleContext context) {
        super(false);
    ...
    public YangToolsBuilderAnnotationIntrospectorXml(@NonNull Class<?> clazz, Class<?> builderClazz) {
        this();
    ...
    protected <A extends Annotation> A _findAnnotation(Annotated ann, Class<A> annoClass) {
        A x = super._findAnnotation(ann, annoClass);
        String name = ann.getName();
        Class<?> rawType = ann.getRawType();
        return x;
    }
