...
from .odlclient import OdlClient, OdlResponse
...
class TrpceOdlClient(OdlClient):
    ...
    def linkRoadmToRoadm(self, roadmANodeId, roadmADeg, roadmATermPoint, roadmZNodeId, roadmZDeg, roadmZTermPoint) -> OdlResponse:
        data = {
            "input": {
    ...
    def linkXpdrToRoadm(self, xpdrNode, xpdrNum, xpdrNetworkPortNumber, roadmNodeId, srgNumber, logicalConnectionPoint) -> OdlResponse:
        data ={
            "input": {
                "links-input": {
                "xpdr-node": xpdrNode,
    ...
    def linkRoadmTpXpdr(self, xpdrNode, xpdrNum, xpdrNetworkPortNumber, roadmNodeId, srgNumber, logicalConnectionPoint) -> OdlResponse:
        data ={
            "input": {
                "links-input": {
                "xpdr-node": xpdrNode,
    ...
    def addOmsAttributes(self, link: str, attr) -> OdlResponse:
    ...
    def createTopoLink(self, linkId, srcXpdrNodeId, srcXpdrNetworkPortId, dstXpdrNodeId, dstXpdrNetworkPortId) -> OdlResponse:
        data={
    ...
    def createService(self,serviceData) -> OdlResponse:
    ...
    def getService(self, serviceName) -> OdlResponse:
    ...
    def getIetfNetworkNodes(self, networkId) -> OdlResponse:
